...
public class CustomersServiceImpl implements ICustomerService {
    ...
    public CustomerDetailsDto fetchCustomerDetails(String mobileNumber) {
        ...
        ResponseEntity<CardDto> cardDtoResponse= cardsFeignClient.fetchCardDetails(mobileNumber);
        customerDetailsDto.setCardDto(cardDtoResponse.getBody());

        ResponseEntity<LoanDto> loanDtoResponse = laonsFeignClient.fetchLoanDetails(mobileNumber);
